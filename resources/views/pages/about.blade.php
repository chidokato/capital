...
<div class="page-banner-simple bg-secondary py-40" style="margin-top: 70px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
...
<div class="full-row pb-30">
        ...
        <div class="full-row paraxify" style="background-image: url(&quot;assets/images/background/bg-4.png&quot;); background-repeat: no-repeat; background-position: center -12.97px; background-size: cover;">
            <div class="container">
                <div class="row">
